...
import { KeyRound, ExternalLink, AlertCircle, RefreshCw } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
      ...
      {isKeyMissing && (
        <div className="bg-blue-600 text-white px-4 py-2.5 flex items-center justify-center space-x-6 z-30 shadow-lg">
      ...
      <main className="flex-1 max-w-[1600px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {errorMessage && (
          <div className="mb-6 bg-rose-50 border-l-4 border-rose-500 p-5 rounded-xl shadow-sm max-w-4xl mx-auto flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-[calc(100vh-140px)] min-h-[700px]">
          ...
          <div className="lg:col-span-7 h-full">
            <OutputSection news={generatedNews} isEmpty={appState === AppState.IDLE || appState === AppState.LOADING} onArchive={handleArchive} />
          </div>
        </div>
      </main>
      <ChatBot />
